...
class Queue : public QueueBase
{
  public:
    ...
    virtual Ptr<Item> PushOut(){return nullptr;}; //
    virtual Ptr<const Item> GetTailPacket() const {return nullptr;}; //
  ...
  protected:
    ...
    Ptr<Item> DoRemovePushOut (ConstIterator pos); 
    ...
    void DropAfterEnqueue (Ptr<Item> item); 
