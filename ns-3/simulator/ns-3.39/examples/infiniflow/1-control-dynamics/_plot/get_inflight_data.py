...
output_dir = sys.argv[1] + "/ns-3/simulator/ns-3.39/examples/infiniflow/1-control-dynamics/monitor_output/metrics_output"
...
def process_log_file(file_path):
    ...
    for m in metrics:
        ...
        for key, records in data[m].items():
            ...
            print(f"    {m:<10} -> {key}.csv ({len(df)} lines)")

filename = sys.argv[1] + "/ns-3/simulator/ns-3.39/examples/infiniflow/1-control-dynamics/monitor_output/1-control-dynamics.out"
