...
def plot_queue_length(file_path, source_node, destination_node):
    ...
    # 保存图像到指定路径
    plt.savefig('/home/pnic/valve-ns3/simulator/ns-3.39/examples/valve/_figure/'+ sys.argv[1] +'/qlen_10to1.'+sys.argv[2], format= sys.argv[2],bbox_inches='tight')
...
if len(sys.argv) <= 2:
    ...
    file_path = '/home/pnic/valve-ns3/simulator/ns-3.39/examples/valve/'+ sys.argv[1] +'/monitor_output/qlen_10to1.txt'  # 替换为你的txt文件路径
