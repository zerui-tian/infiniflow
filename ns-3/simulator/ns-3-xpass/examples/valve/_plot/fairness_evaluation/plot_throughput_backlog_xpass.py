...
def plot_link_throughput(throughput_file_path, qlen_file_path, source_node, destination_node):
    ...
    plt.savefig('/home/pnic/valve-ns3/simulator/ns-3.39/examples/valve/_figure/fairness_evaluation/qlen_and_throughput_fairness_xpass6.svg', format='svg',bbox_inches=None)

source_node = 2
destination_node = 1

# 示例调用
# throughput_file_path = '/home/pnic/valve-ns3/simulator/ns-3.39/examples/valve/_archive/fairness_evaluation/throughput_and_qlen/throughput_xpass.txt'  # 替换为你的txt文件路径
# qlen_file_path = '/home/pnic/valve-ns3/simulator/ns-3.39/examples/valve//_archive/fairness_evaluation/throughput_and_qlen/qlen_xpass.txt'
throughput_file_path = '/home/pnic/valve-ns3/simulator/ns-3.39/examples/valve/fairness_evaluation/monitor_output/throughput.txt'  # 替换为你的txt文件路径
qlen_file_path = '/home/pnic/valve-ns3/simulator/ns-3.39/examples/valve/fairness_evaluation/monitor_output/qlen.txt'
