...
def plot_queue_length(file_path, source_node, destination_node):
    ...
    # 保存图像到指定路径
    plt.savefig('/home/pnic/valve-ns3/simulator/ns-3.39/examples/valve/_figure/'+ sys.argv[1] +'/qlen_fairness.'+sys.argv[2], format= sys.argv[2],bbox_inches='tight')
