...
def plot_link_throughput(file_path, source_node, destination_node):
    ...
    # 保存图像到指定路径
    plt.savefig('/home/pnic/valve-ns3/simulator/ns-3.39/examples/valve/_figure/'+ sys.argv[1] +'/throughput_fairness.'+sys.argv[2], format= sys.argv[2],bbox_inches='tight')
...
if len(sys.argv) <= 2:
    ...
    file_path = '/home/pnic/valve-ns3/simulator/ns-3.39/examples/valve/'+ sys.argv[1] +'/monitor_output/throughput.txt'  # 替换为你的txt文件路径
