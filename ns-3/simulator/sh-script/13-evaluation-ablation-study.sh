...
mkdir -p $BASE_SIMULATION_ROOT/ns-3/simulator/result/data/13-evaluation-ablation-study
# ============================================================
# Define target projects and their script paths
# ============================================================

# List of project names (as subdirectories under BASE_SIMULATION_ROOT/ns-3/simulator/)
PROJECTS=(
    "ns-3-infiniflow-mmf"
...
SCRIPT_REL_PATH="examples/SharedCredit-FC/ablation-study/script.sh"
...
echo
echo "🎉 All ablation study scripts executed successfully."
echo "============================================================"